    ...
    <>
      <footer className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10 ">
          <div className="col-span-full hidden lg:col-span-1 lg:block mr-5">
            <img src={Footerimg} alt="Nexcap Logo" className="w-32" />
          ...
          <div>
            ...
            <div className="mt-3 grid space-y-3 text-sm text-gray-400 ">
              <p>
                <Link
                  to="privacy"
          ...
          <div>
            ...
            <div className="mt-3 grid space-y-3 text-sm text-gray-400 ">
              ...
              <p>
                <a href="internships" className="inline-flex gap-x-2 hover:text-gray-200 ">Careers
                  
                  
                <span className="inline text-yellow-500 hover:text-yellow-600">— We're hiring</span>
          ...
          <div>
            <h4 className="text-xs font-semibold text-gray-900 uppercase dark:text-gray-100 pb-4">
              get in touch
            </h4>
            ...
            <a href="mailto:info@nexcap.net">
              {" "}
              <h4 className="cursor-pointer mt-3 text-base  text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                info@nexcap.net
              </h4>
            </a>
            <br></br>
        ...
        <div className="mt-5 mb-20 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
