                ...
                <div className="py-8 lg:pe-8">
                  <div className="space-y-5 lg:space-y-8 text-lg">
                    ...
                    <div className="flex items-center gap-x-5">
                      <div className="inline-flex items-center gap-1.5 py-1 px-3 sm:py-2 sm:px-4 rounded-full text-xs sm:text-sm bg-gray-800 hover:bg-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-600">
                        Nexcap
                      </div>
                    ...
                    <p className="text-xl">What is SEO ?</p>
                    <p className="text-lg ">
                    ...
                    <p className="text-xl my-5 ">Key Components of SEO:</p>
                    ...
                    <p className="text-xl my-5">Importance of SEO : </p>
                    <ol className="list-decimal">
                      <li className="my-5">
                        <p>
                          <span className="text-amber-100">
