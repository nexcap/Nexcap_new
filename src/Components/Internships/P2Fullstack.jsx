  ...
  const Program2 = [
    {
      ...
      description:
        "We are hiring for Remote Full Stack Web Developer Interns(Frontend + Backend).",
      res1: "Creating web pages using frontend technologies (HTML, CSS, and JavaScript, etc.)",
      res2: "Maintain and develop server side using backend technologies (Python, Java, and Django, etc.)",
      qua1: "Knowledge of Web Development technologies.",
      qua2: "Proficiency in English Language.",
      qua3: "Access to PC/Laptop and Internet",
      ...
      applylink:"https://forms.gle/y3caFhaRgo6Mdccw5 "
    },
  ];
  return (
    <>
    <Helmet>
        <title>
        Full Stack Web Development - Nexcap 
        </title>
        <meta
          name="description"
          content="We are hiring for Remote Full Stack Web Developer Interns. (Frontend + Backend) Interested candidates can apply."
        />
        <meta
          name="keywords"
