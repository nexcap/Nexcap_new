  ...
  const Program3 = [
    {
      ...
      description:
        "We are hiring for Java programming Interns.",
      res1: "Developing applications using Java technologies (Java SE, Java EE, etc.)",
      qua1: "Knowledge of Java programming language.",
      ...
      ben3: "Letter of Recommendation",
        ...
        applylink:"https://forms.gle/zxpTsyN5U6wi8T4s6 "
    },
  ];
  return (
    <>
    <Helmet>
        <title>
        Java Web Development internship - Nexcap 
        </title>
        <meta
          name="description"
          content="We are hiring for Java programming Interns. Interested candidates can apply.."
        />
        <meta
          name="keywords"
