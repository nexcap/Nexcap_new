  ...
  const Program1 = [
    {
      ...
      description:
        "We are hiring for Remote Frontend Web Developer Interns.",
      ...
      applylink:"https://forms.gle/xqtmdjuEbdCLAjWCA "
    },
  ];
  return (
    <>
    <Helmet>
        <title>
        Frontend Web Development internship - Nexcap 
        </title>
        <meta
          name="description"
          content="We are hiring for Remote Frontend Web Developer Interns. (Frontend) Interested candidates can apply."
        />
        <meta
          name="keywords"
