...
import Profile from "../../imgs/jana.jpg";
...
const Jana = () => {
  return (
    <>
      <Helmet>
        <title>Janapriya SP - Nexcap</title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="Janapriya SP , Janapriya SP nexcap, Janapriya SP nexcap, jp Nexcap,Nexcap , Nexcap company , Nexcap Inc."
        />
      ...
      <div>
        ...
        <div className="px-2 py-4 mt-7 flex flex-col justify-center items-center text-center">
          <img
            ...
            alt="Janapriya Nexcap"
            src={Profile}
          />
          <h1 className="text-2xl text-gray-50 font-bold mt-3">Janapriya SP</h1>
          ...
          <ul className="flex flex-row mt-3">
            <li className="mx-2">
              <a
                href="https://www.linkedin.com/in/janapriya-sp-jp2003/"
                target="_blank"
                rel="noreferrer"
                aria-label="LinkedIn"
              >
