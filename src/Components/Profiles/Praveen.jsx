...
import Profile from "../../imgs/Praveen.jpeg";
...
const Praveen = () => {
  return (
    <>
      <Helmet>
        <title>Praveen kumar D - Nexcap</title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="Praveen kumar D , Praveen kumar D nexcap, Praveen kumar D nexcap,Nexcap , Nexcap company , Nexcap Inc."
        />
      ...
      <div>
        ...
        <div className="px-2 py-4 mt-7 flex flex-col justify-center items-center text-center">
          <img
            ...
            alt="Praveenkumar Nexcap"
            src={Profile}
          />
          <h1 className="text-2xl text-gray-50 font-bold mt-3">Praveen kumar D</h1>
          ...
          <ul className="flex flex-row mt-3">
            <li className="mx-2">
              <a
                href="https://www.linkedin.com/in/praveen-kumar-d-852175248/"
                target="_blank"
                rel="noreferrer"
                aria-label="LinkedIn"
              >
