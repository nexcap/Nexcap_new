...
import Profile from "../../imgs/pratheema.jpg";
...
const Pratheema = () => {
  return (
    <>
      <Helmet>
        <title>Pratheema I - Nexcap</title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="Pratheema , Pratheema nexcap,Pratheema nexcap, Nexcap , Nexcap company , Nexcap Inc."
        />
      ...
      <div>
        ...
        <div className="px-2 py-4 mt-7 flex flex-col justify-center items-center text-center">
          <img
            ...
            alt="Pratheema Nexcap"
            src={Profile}
          />
          <h1 className="text-2xl text-gray-50 font-bold mt-3">Pratheema I</h1>
          ...
          <ul className="flex flex-row mt-3">
            <li className="mx-2">
              <a
                href="https://www.linkedin.com/in/pratheema-i-7a5295251/"
                target="_blank"
                rel="noreferrer"
                aria-label="LinkedIn"
              >
