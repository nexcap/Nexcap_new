              ...
              <div class="py-8 lg:pe-8">
                ...
                <Link to='/#blogs'
                  ...
                  <div
                    ...
                    <p class="text-xs sm:text-sm">February 13, 2023</p>
                  </div>
                  ...
                  <p class="text-base  text-amber-100">
            ...
            <div class="lg:col-span-1 lg:w-full sticky top-20  rounded-tl-3xl  rounded-bl-3xl ">
              <div class="sticky top-0 start-0 py-8 pt-28 lg:ps-8">
                ...
                <div class="space-y-6">
                  ...
                  <Link class="group flex items-center gap-x-6" to="/Explore-the-Boundless-Realms-of-Virtual-Reality-Technology">
                    <div class="grow">
                      <span class="text-sm   group-hover:text-amber-100">
