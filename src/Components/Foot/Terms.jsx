    ...
    <div>
      <ScrollToTop>
        <div className="text-white max-w-4xl px-4 pt-6 lg:pt-10 pb-12 sm:px-6 lg:px-8 mx-auto">
          ...
          <p className="my-5 text-amber-100">Last updated: February 28, 2024</p>
          <p className="my-2">
            Please read these terms and conditions carefully before using Our
            Service.
          </p>
          <p  className="text-xl my-5 text-amber-100">Interpretation and Definitions</p>
          ...
          <p className="text-xl my-5 text-amber-100">Acknowledgment</p>
          <p className="my-2">
          ...
          <p className="text-xl my-5 text-amber-100">Links to Other Websites</p>
          <p className="my-2">
          ...
          <p className="text-xl my-5 text-amber-100">Termination</p>
          <p className="my-2">
          ...
          <p className="text-xl my-5 text-amber-100">Limitation of Liability</p>
          <p className="my-2">
          ...
          <p className="text-xl my-5 text-amber-100">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</p>
          <p className="my-2">
          ...
          <p className="text-xl my-5 text-amber-100">Governing Law</p>
          <p className="my-2">
          ...
          <p className="text-xl my-5 text-amber-100">Disputes Resolution</p>
          <p className="my-2">
            If You have any concern or dispute about the Service, You agree to
            first try to resolve the dispute informally by contacting the
            Company.
          </p>
          <p className="text-xl my-5 text-amber-100">For European Union (EU) Users</p>
          <p className="my-2">
            If You are a European Union consumer, you will benefit from any
            mandatory provisions of the law of the country in which You are
            resident.
          </p>
          <p className="text-xl my-5 text-amber-100">United States Legal Compliance</p>
          <p className="my-2">
          ...
          <p className="text-xl my-5 text-amber-100">Severability and Waiver</p>
          <p className="text-lg my-3 text-amber-100">Severability</p>
          <p className="my-2">
          ...
          <p className="text-lg my-3 text-amber-100">Waiver</p>
          <p className="my-2">
          ...
          <p className="text-xl my-5 text-amber-100">Translation Interpretation</p>
          <p className="my-2">
            These Terms and Conditions may have been translated if We have made
            them available to You on our Service. You agree that the original
            English text shall prevail in the case of a dispute.
          </p>
          <p className="text-xl my-5 text-amber-100">Changes to These Terms and Conditions</p>
          <p className="my-2">
          ...
          <p className="text-xl my-5 text-amber-100">Contact Us</p>
          <p className="my-2">
